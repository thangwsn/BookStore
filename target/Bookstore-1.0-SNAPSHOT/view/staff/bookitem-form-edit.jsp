                    ...
                    <div class="col-lg-12">
                        <div>
                            ...
                            <form class="row" method="post"
                                  action="${pageContext.request.contextPath}/book/editBookItem"
                                  id="register_form">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Summary</label>
                                    <textarea class="form-control" rows="5" name="summary">${bookItem.summary}
                                    </textarea>
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    />
                                    <input type="hidden" name="soldQuantity" value="${bookItem.soldQuantity}">
                                </div>
                                <div class="col-md-6 form-group">
